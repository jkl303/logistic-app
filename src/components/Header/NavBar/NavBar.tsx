      ...
      <ContainerStyled>
        <NavBarStyled>
          <NavStyled>
            ...
            <div>
              <NavLinkStyled to="/about-us">About</NavLinkStyled>
            </div>
            <div>
              <PagesStyled
              ...
              >
                ...
                {isShowPages && (
                  <nav>
                    <PagesLinkStyled to="/service">Services</PagesLinkStyled>
                    <PagesLinkStyled to="/service-single">
                      Service Single
                    </PagesLinkStyled>
                    <PagesLinkStyled to="/our-team">Our Team</PagesLinkStyled>
                    <PagesLinkStyled to="/pricing">Pricing</PagesLinkStyled>
                    <PagesLinkStyled to="/blog">Blog</PagesLinkStyled>
                  </nav>
                )}
              </PagesStyled>
            </div>
            <div>
              <NavLinkStyled to="/our-project">Project</NavLinkStyled>
            </div>
            <div>
          ...
          <RequestLinkStyled to="/contact-us">Request Quote</RequestLinkStyled>
        </NavBarStyled>
      </ContainerStyled>
    </NavBarWrapper>
  );
