...
export const Reviews: FC<{ darkBG?: boolean }> = ({
  darkBG,
}) => {
        ...
        <ReviewsListStyled position={reviewsPositon}>
          ...
          <ReviewStyled>
            ...
            <ReviewTextStyled>
              ...
              some of our biggest customers. They have been
              very reliable and have provided great service
