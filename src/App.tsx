...
const ProjectSingle = lazy(() => import("./pages/ProjectSingle/ProjectSingle"));
    ...
    <>
      <Routes>
        <Route path="/" element={<SharedLayout />}>
          ...
          <Route path="/project/:name" element={<ProjectSingle />} />
          <Route path="/blog" element={<Blog />} />
          <Route path="/post/:title" element={<BlogSingle />} />
